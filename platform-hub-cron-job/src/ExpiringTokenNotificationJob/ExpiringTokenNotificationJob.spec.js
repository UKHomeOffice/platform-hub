...
describe('ExpiringTokenNotificationJob', () => {
  ...
  describe('#run', () => {
    it('gets expiring tokens', () => {
      ...
      tokenRepositoryMock.getExpiringTokens.resolves([{name:"test@test.com", kind: 'user', uid:"12a3bc45-1234-1234-abc1-1234a5b67c89", date_trunc: new Date("2021-02-18 11:39:10")}]);
    ...
    it('sends an email for each expiring token', () => {
      ...
      tokenRepositoryMock.getExpiringTokens.resolves([{name:"test@test.com", kind: 'robot', uid:"12a3bc45-1234-1234-abc1-1234a5b67c89", date_trunc: new Date("2021-02-18 11:39:10")}, {name:"test2@test.com", kind: 'user', uid:"12a3bc45-1234-1234-abc1-1234a5b67c89", date_trunc: new Date("2021-02-18 11:39:10")}]);
