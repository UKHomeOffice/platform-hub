...
* [Ruby v2.3.3](https://www.ruby-lang.org/en/). If you're using [RVM](https://rvm.io/) or some other Ruby manager, it may pick up the `.ruby-version` file automatically and use / set up the correct version of Ruby for you. If not, you'll need to install Ruby v2.3.3 or above (included in the below list).
* Developer Packages:
...
Kubernetes::StaticTokenService.import(<cluster-id>, <kind>)
```
where:
...
#### Describe static kubernetes account
